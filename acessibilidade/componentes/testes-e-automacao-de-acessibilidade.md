# Testes e automação de acessibilidade

Esta categoria organiza a estratégia de qualidade para impedir que acessibilidade dependa apenas de revisão pontual ou de uma ferramenta isolada.
...
- [Critérios de aceite dos componentes](criterios-de-aceite.md)
