...
O componente pode parecer um select visualmente, mas a recursos de tecnologia assistiva não identifica sua função, seu valor ou a relação com as opções. A seleção pode ficar impossível sem mouse/toque.
