...
**Por que falha:** os recursos de tecnologia assistiva anunciam função de link, mas o comportamento esperado é de botão. A semântica e a expectativa de interação não correspondem à ação executada.
