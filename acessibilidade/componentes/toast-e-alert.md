...
Após salvar uma alteração, aparece visualmente `Alterações salvas` e os recursos de tecnologia assistiva recebem anúncio equivalente, sem mudança de foco. O foco permanece no controle ou contexto da tarefa.
