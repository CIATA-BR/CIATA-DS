...
Não acrescentar palavras como `caixa de seleção` ao nome acessível quando os recursos de tecnologia assistiva já anunciam o papel.
...
- os recursos de tecnologia assistiva devem anunciar o novo estado pelo comportamento nativo da plataforma.
