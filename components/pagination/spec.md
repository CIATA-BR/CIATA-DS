...
## Semântica
Na Web, envolver o conjunto em uma região de navegação com nome, como `aria-label="Paginação"`, e usar links para navegação real. A página atual deve expor `aria-current="page"`. Não acrescentar a palavra “link” ou “botão” ao nome acessível quando a recursos de tecnologia assistiva já anuncia o papel.
