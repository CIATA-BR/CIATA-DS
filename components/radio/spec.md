...
Não acrescentar palavras como `botão de opção` ao nome acessível quando a recursos de tecnologia assistiva já anuncia o papel.
...
Antes de ser considerado estável, cada implementação deve possuir evidência real de teste com tecnologias assistivas relevantes, registrando plataforma, versão, recursos de tecnologia assistiva, cenário, resultado e limitações.
