...
Registrar plataforma, versão, recursos de tecnologia assistiva, navegador/dispositivo, cenário executado, resultado esperado/observado, falhas e limitações.
...
4. validação manual com recursos de tecnologia assistiva relevantess tiver ocorrido de fato.
