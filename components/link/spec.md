...
Não acrescentar a palavra `link` ao nome acessível quando os recursos de tecnologia assistiva já anunciam o papel.
...
- não criar atalhos ou interceptações que quebrem comandos de recursos de tecnologia assistiva.
